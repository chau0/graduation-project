...
<nav id="nav" class="ui-widget-header">
	<div class="ym-wrapper">
		<div class="ym-hlist ui-widget-header">
			<ul id="navlist">
				<li><s:url var="mainurl" action="list-professors" /><sj:a id="main" href="%{mainurl}" targets="main_content">Danh sach giang vien</sj:a></li>
				<li><s:url var="dataurl" action="list-data-sets" /><sj:a id="data" href="%{dataurl}" targets="main_content">Lap lich</sj:a></li>
			</ul>
		</div>
	</div>
</nav>
